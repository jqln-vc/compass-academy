...
* **Preparação do Ambiente Ecommerce** [֍](#preparação-do-ambiente-ecommerce)
  * Bônus: preparacao_ecommerce.sh [֍](#bônus-preparacao_ecommercesh)
    * Fluxo de Lógica: Preparação de Ecommerce [֍](#fluxo-de-lógica-preparação-de-ecommerce)
* **Processamento de Vendas** [֍](#processamento-de-vendas)
  * Função: vendas_backup [֍](#função-vendas_backup)
    * Fluxo de Lógica: Criação de Pastas Vendas e Backup [֍](#fluxo-de-lógica-criação-de-pastas-vendas-e-backup)
    * Função: relatorio [֍](#função-relatorio)
      * Fluxo de Lógica: Geração de Relatório [֍](#fluxo-de-lógica-geração-de-relatório)
    * Função: compressao [֍](#função-compressao)
      * Fluxo de Lógica: Compressão de Arquivo de Backup [֍](#fluxo-de-lógica-compressão-de-arquivo-de-backup)
    * Função: limpeza_arquivos [֍](#função-limpeza_arquivos)
      * Fluxo de Lógica: Limpeza de Arquivos Processados [֍](#fluxo-de-lógica-limpeza-de-arquivos-processados)
* **Consolidação do Processamento de Vendas** [֍](#consolidação-do-processamento-de-vendas)
  * Função: consolidacao [֍](#função-consolidacao)
    * Fluxo de Lógica: Consolidação de Relatórios [֍](#fluxo-de-lógica-consolidação-de-relatórios)
      * Execução [֍](#execução)
* **Agendamento de Rotinas: crontab** [֍](#agendamento-de-rotinas-crontab)
  * Execução de Cron Job [֍](#execução-de-cron-job)
* **Geração de Dataset para Relatório Subsequentes** [֍](#geração-de-dataset-para-relatórios-subsquentes)
* **Metologia Utilizada** [֍](#metodologia-utilizada)
  * Cabeçalho e Seccionamento [֍](#cabeçalho-e-seccionamento)
  * Variáveis Semânticas [֍](#variáveis-semânticas)
