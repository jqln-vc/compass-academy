...
- **Compreensão Inicial dos Dados** [֍](#compreens%C3%A3o-inicial-dos-dados)
  - Diagrama Conceitual [֍](#diagrama-conceitual)
    - Tratamento de Dados [֍](#tratamento-de-dados)
    - Data de Locação e Data de Entrega [֍](#data-de-loca%C3%A7%C3%A3o-e-data-de-entrega)
    - Hora de Locação e Hora de Entrega [֍](#hora-de-loca%C3%A7%C3%A3o-e-hora-de-entrega)
  - Bônus Investigativo [֍](#b%C3%B4nus-investigativo-%EF%B8%8F)
- **Contextualização: Sistemas OLTP x OLAP** [֍](#contextualiza%C3%A7%C3%A3o-sistemas-oltp-x-olap)
  - Sistemas-Fonte: Normalização [֍](#sistemas-fonte-normaliza%C3%A7%C3%A3o)
  - Data Warehouse: Modelagem Dimensional [֍](#data-warehouse-modelagem-dimensional)
- **Metodologia Adotada: Híbrido de Inmon e Kimball** [֍](#metodologia-adotada-h%C3%ADbrido-de-kimball-e-inmon) 
- **Processo de Normalização** [֍](#processo-de-normaliza%C3%A7%C3%A3o)
  - 1ª Formal Normal [֍](#1%C2%AA-forma-normal)
  - 2ª Forma Normal [֍](#2%C2%AA-forma-normal)
  - 3ª Forma Normal [֍](#3%C2%AA-forma-normal)
  - Concessionária: Banco Relacional Normalizado [֍](#concession%C3%A1ria-banco-relacional-normalizado)
    - Obtendo a Kilometragem Atual: Exemplo de Implementação com View [֍](#obtendo-a-kilometragem-atual-exemplo-de-implementa%C3%A7%C3%A3o-com-view)
- **Processo de Modelagem Dimensional** [֍](#processo-de-modelagem-dimensional)
  - Surrogate Keys: Chaves Substitutas [֍](#surrogate-keys-chaves-substitutas)
  - Tabela-Fato Locação: Tipo Snapshot Acumulativo [֍](#tabela-fato-loca%C3%A7%C3%A3o-tipo-snapshot-acumulativo)
    - Dimensão Data: Tipo Role-Playing [֍](#dimens%C3%A3o-data-tipo-role-playing)
  - Star Schema [֍](#star-schema)
  - Snowflake Schema [֍](#snowflake-schema)
  - Cubos: Camada de Análise Multidimensional [֍](#cubos-camada-de-an%C3%A1lise-multidimensional)
- **Futuras Melhorias no Projeto** [֍](#futuras-melhorias-no-projeto)
...
> ❗ Na seção [***Obtendo A Kilometragem Atual: Exemplo Com View***](#obtendo-a-kilometragem-atual-exemplo-de-implementa%C3%A7%C3%A3o-com-view), será mostrada uma maneira de obter os valores de kilometragem para cada veículo, de modo a facilitar a análise operacional sem comprometer a **normalização** do banco relacional.
...
Com frequência, após a obtenção da 2ª forma normal, é possível já se ter chegado também à 3ª forma normal. No entanto, não foi o caso, aqui são retomadas as observações não-triviais de `vlrDiaria` e `kmCarro` identificadas na seção [Compreensão Inicial dos Dados](#compreens%C3%A3o-inicial-dos-dados).
